...
class StripePaymentServiceValidator extends PaymentServiceValidator implements Validator
{

    private $mandatory_fields = [ "amount", "currency", "description", "card" ];
    private $card_mandatory_fields = [ "number", "expiry_month", "expiry_year", "cvc" ];
